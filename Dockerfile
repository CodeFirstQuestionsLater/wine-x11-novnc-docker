...
RUN dpkg --add-architecture i386 && \
    ...
    apt-get update && apt-get -y install winehq-stable=7.4.0.0~focal-1  && \
...
WORKDIR /root/
RUN wget -O - https://github.com/novnc/noVNC/archive/v1.3.0.tar.gz | tar -xzv -C /root/ && mv /root/noVNC-1.1.0 /root/novnc && ln -s /root/novnc/vnc_lite.html /root/novnc/index.html && \
